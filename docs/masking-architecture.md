# 감사파일 개인정보 마스킹 자동화 — 아키텍처 설계서 (v12)
...
2. 도구가 어느 정도 완성되면 **과장님께 프로토타입으로 시연** — 이 시점 전까지는 실제 업무에 투입하지 않음
3. 실제 감사파일에 사용할지, 추가 검토(정보보안팀 등)가 필요한지는 **과장님의 판단에 맡김** — 인턴이 임의로 실사용 여부를 결정하지 않음
